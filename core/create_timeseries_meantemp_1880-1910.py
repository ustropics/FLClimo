...
for location in locations:
    ...
    popup_html = "<b>{station_name} ({station_id})</b><br>lat: {station_lat}, lon: {station_lon}<br><a href='../../static/img/plots/timeseries/meantemp_daily/{station_id}_1880-1910.png' target='_BLANK'><img src='../../static/img/plots/timeseries/meantemp_daily/{station_id}_1880-1910.png' width='100%' height='100%'></a>".format(
...
florida_map.save('../template/maps/map_timeseries_meantemp_1880-1910.html')

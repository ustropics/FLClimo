...
for location in locations:
    ...
    trend = location['trend_maxtemp_yearly']
    ...
    popup_html = "<b>{station_name} ({station_id})</b><br>lat: {station_lat}, lon: {station_lon}<br><a href='../../static/img/plots/trends/maxtemp_yearly/{station_id}_max_trend_yearly.png' target='_BLANK'><img src='../../static/img/plots/trends/maxtemp_yearly/{station_id}_max_trend_yearly.png' width='100%' height='100%'></a>".format(
...
florida_map.save('../template/maps/map_trend_maxtemp_yearly.html')

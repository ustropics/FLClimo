...
for location in locations:
    ...
    popup_html = "<b>{station_name} ({station_id})</b><br>lat: {station_lat}, lon: {station_lon}<br><a href='../../static/img/plots/timeseries/precip_daily/{station_id}_1970-2000.png' target='_BLANK'><img src='../../static/img/plots/timeseries/precip_daily/{station_id}_1970-2000.png' width='100%' height='100%'></a>".format(
...
florida_map.save('../template/maps/map_timeseries_precip_1970-2000.html')
